...
#define _GEMINI_LOG_INFO ::gemini::internal::LogMessage(__FILE__, __LINE__, ::gemini::INFO)
#define _GEMINI_LOG_WARNING ::gemini::internal::LogMessage(__FILE__, __LINE__, ::gemini::WARNING)
#define _GEMINI_LOG_ERROR ::gemini::internal::LogMessage(__FILE__, __LINE__, ::gemini::ERROR)

...
bool MakeSamePadShape(const TensorShape& tensor_shape, const TensorShape& filter_shape,
                      TensorShape& output_shape);

std::optional<TensorShape> Conv2D(const TensorShape& tensor_shape, const TensorShape& filter_shape,
...
bool Conv2D(const TensorShape& tensor_shape, const TensorShape& filter_shape,
            const size_t poly_degree, Padding padding, size_t stride, TensorShape& strided_tshape,
            std::array<int, 2>& paddings, std::array<int, 3>& slice_strides);
